...
| `GP2` | `LIFT_HOME` normally-open microswitch to local `TOOL_GND`. Firmware uses `INPUT_PULLUP`; released reads HIGH and the fully retracted carriage reads LOW. The current implementation reports this in USB telemetry only; it does not yet control motor motion. |
| `GP4` | DRV8833 `IN1` |
| `GP5` | DRV8833 `IN2` |
