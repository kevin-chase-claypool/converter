...
| [`e09e_cs1238_pen_scale_pulse/e09e_cs1238_pen_scale_pulse.ino`](e09e_cs1238_pen_scale_pulse/e09e_cs1238_pen_scale_pulse.ino) | Dedicated installed-pen/kitchen-scale direction check after E-09C. Its runtime service link is UART1 (`GP20` TX / `GP21` RX) through the existing 3.3 V USB-to-TTL adapter, with adapter VCC disconnected; USB-C is flash-only while the external toolhead rail is disconnected. Arduino IDE Serial Monitor at 115200 supports immediate `t`, `a`, `d`, `u`, `r`, `x`, `[`, `]`, and `?` shortcuts: tare, arm, individual supervised 10–100 ms N20 pulses, raw read, stop, duration adjustment, and help. It checks `ULT`, sleeps after every pulse, and blocks lift when GP2 is pressed. It has no M3/M5, GP27, continuous drive, or automatic force seeking. | CS123x by FMazz97, 1.1.0 |
