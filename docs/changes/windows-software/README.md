...
|---|---|---|---|---|
| 2026-09-05 | `WSW-20260905-002` | planned | [Plan radius-aware A-axis feed for drawing](2026/2026-09-05-radius-aware-a-feed-requirement.md) | `theta`, `a-axis`, `tangential-speed`, `radius`, `feed-planning` |
