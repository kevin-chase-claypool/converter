...
P109 commands one known-safe automatic XY move. Stop immediately if it enters
`Home` or approaches a switch. If it passes, the next diagnostic must isolate
the first G38 probe row rather than repeat the full Q5 raster.
