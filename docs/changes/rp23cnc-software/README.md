...
| 2026-09-08 | `RPSW-20260908-002` | implemented | [Fix integrated service-UART telemetry suppression](2026/2026-09-08-fix-integrated-service-uart-telemetry.md) | `toolhead`, `uart`, `telemetry`, `diagnostics` |
