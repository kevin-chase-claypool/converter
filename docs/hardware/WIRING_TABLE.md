...
| SAF-006 | MEISHILE `S-120-12` | `+V` through FMAIN | HCDC `HD064RT` | `DC INPUT +` | 12 V motor/tool feed | 12 V while the main power is on; E-stop does not remove this power | Protected 12 V positive TBD | partial | On 2026-08-20, the powered HD064RT input and one output pair each measured 12.05 VDC and polarity matched the block markings. FMAIN maximum 10 A; do not bypass it. PE bonding, adjustment range, fitted fuse, and loaded behavior remain open; see E-11 lab note. |
