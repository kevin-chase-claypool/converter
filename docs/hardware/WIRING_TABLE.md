...
| PWR-001E | Protective earth | PE | MEISHILE S-120-12 | Terminal 3 earth | Protective earth | Safety bonding conductor | Green, verified | X cable shield/drain landed here; continuity TBD | verified — terminal identity/landing only | Owner verified the green wall-earth conductor and green X sheath/drain are landed at the protective-earth symbol terminal. Verify low-resistance chassis continuity before power. This is never `-V`, `L`, or `N`. |
...
| XSH-001 | X motor cable shield/drain | Green sheath/drain wire at TB6600 end | MEISHILE S-120-12 protective-earth terminal | Earth symbol / PE | Cable shield bond | Green, verified | partial — `-V` isolation passed | Owner verified this wire is landed at the same protective-earth terminal as the wall's earth conductor and measured no continuity to DC `-V` on 2026-08-23. Insulate shield at motor end; verify continuity to PE/chassis and isolation from motor phases. |
