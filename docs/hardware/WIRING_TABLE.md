...
|---|---|---|---|---|---|---|---|---|---|---|
| PWR-001 | AC mains | Hot | MEISHILE S-120-12 | Terminal 1 `L` | AC line/live | 100-240 VAC listing range | Red, owner-reported | Enclosure, switch, line fuse, strain relief TBD | partial | Verify exact terminal label before power; do not rely on color alone. |
| PWR-001N | AC mains | Neutral | MEISHILE S-120-12 | Terminal 2 `N` | AC neutral | 100-240 VAC listing range | Blue, owner-reported | Same protected inlet as PWR-001 | partial | Keep neutral distinct from protective earth; verify exact terminal label before power. |
| PWR-001E | Protective earth | PE | MEISHILE S-120-12 | Terminal 3 earth | Protective earth | Safety bonding conductor | Green, owner-reported | X cable shield/drain landed here; continuity TBD | partial | Verify low-resistance chassis continuity before power. This is the protective-earth symbol terminal, never `-V`, `L`, or `N`. |
...
| PWR-003 | HCDC HD064RT | `OUT6 +` | X TB6600 | `VCC`/`DC+` TBD | X stepper power | 12 VDC nominal; E-stop does not remove this power | TBD | `OUT6` branch fuse, 2 A selected; confirm fitted marking | planned | Owner allocated X TB6600 to `OUT6`; do not bypass the HD064RT branch fuse. |
| PWR-004 | HCDC HD064RT | `OUT6 -` | X TB6600 | `GND`/`DC-` TBD | X stepper return | 0 VDC | TBD | Paired with PWR-003 | planned | DC return remains continuous. |
| PWR-005 | HCDC HD064RT | `OUT7 +` | Y TB6600 | `VCC`/`DC+` TBD | Y stepper power | 12 VDC nominal; E-stop does not remove this power | TBD | `OUT7` branch fuse, 2 A selected; confirm fitted marking | planned | Owner allocated Y TB6600 to `OUT7`; do not bypass the HD064RT branch fuse. |
| PWR-006 | HCDC HD064RT | `OUT7 -` | Y TB6600 | `GND`/`DC-` TBD | Y stepper return | 0 VDC | TBD | Paired with PWR-005 | planned | DC return remains continuous. |
| PWR-007 | HCDC HD064RT | `OUT8 +` | A TB6600 | `VCC`/`DC+` TBD | A stepper power | 12 VDC nominal; E-stop does not remove this power | TBD | `OUT8` branch fuse, 2 A selected; confirm fitted marking | planned | Owner allocated A TB6600 to `OUT8`; do not bypass the HD064RT branch fuse. |
| PWR-008 | HCDC HD064RT | `OUT8 -` | A TB6600 | `GND`/`DC-` TBD | A stepper return | 0 VDC | TBD | Paired with PWR-007 | planned | DC return remains continuous. |
...
| XSH-001 | X motor cable shield/drain | Green sheath/drain wire at TB6600 end | MEISHILE S-120-12 protective-earth terminal | Earth symbol / PE | Cable shield bond | Green, owner-reported | partially wired, unverified | Owner reports this wire is landed at the same protective-earth terminal as the wall's earth conductor. Insulate shield at motor end; verify continuity to PE/chassis and isolation from DC `-V` after installation. |
