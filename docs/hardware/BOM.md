...
| Qty | Item | Known information | Status | Verification needed |
|---:|---|---|---|---|
| 1 | Amazon ASIN B0CDQSVBFC | 1024GA20/N20 threaded gearmotor, selected listing option 6 V 200 RPM, M4 x 55 mm shaft | selected | E-05 no-load passed; owner reports 0.18 A stall current and preload hold; controlled stall/thermal margin, travel limits, polarity, backlash, and required force remain to be characterized |
