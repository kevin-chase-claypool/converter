...
| 1 | Owner-supplied compression spring | Installed 2026-09-04 as the replacement for the prior spring candidate; owner-reported dimensions are 0.4 mm wire diameter x 7 mm outside diameter x 25 mm free length. On 2026-09-08 it measured 20.37 mm installed/unloaded in its housing; the housing's reported full-compression endpoint is 1.95 mm. | received/installed | The 1.95 mm housing endpoint is not the free spring's `L_solid`; measure free-spring solid height or obtain its specification. Then measure LIFT/contact/selected-minimum lengths, force curve, margins from coil bind and the housing endpoint, and direction in T-01A/T-01B before reusing any prior spring-dependent value. |
