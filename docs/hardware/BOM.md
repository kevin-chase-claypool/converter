...
| 1 | Replacement N20 threaded gearmotor, 6 V 400 RPM option | Ordered 2026-09-09 to evaluate a faster toolhead actuator. Exact listing, shaft, gearbox ratio, torque, and current specifications remain to be recorded on receipt. | ordered | Before fitting: inspect shaft/thread compatibility. After fitting: repeat E-05, guarded E-06/E-15, direction, GP2 travel, backlash, force, and pulse-response characterization; do not reuse 200 RPM results. |
| 1 | Replacement N20 threaded gearmotor, 6 V 1000 RPM option | Ordered 2026-09-09 to evaluate a faster toolhead actuator. Exact listing, shaft, gearbox ratio, torque, and current specifications remain to be recorded on receipt. | ordered | Before fitting: inspect shaft/thread compatibility. After fitting: repeat E-05, guarded E-06/E-15, direction, GP2 travel, backlash, force, and pulse-response characterization; do not reuse 200 RPM results. |
| 1 | ACEIRMC DRV8833 module, Amazon ASIN B08RMWTDLM | 3-10 V dual H-bridge module, mounted on the shared toolhead perfboard. The owner confirmed the installed board's labels: `EEP` is the low-true sleep input and `ULT` is the low-true protection/fault output. | received | Preserve installed harness GP6→`EEP` and `ULT`→GP7. The prior opposite mapping is superseded. Reflash corrected firmware, then re-run E-14C and the guarded T-01 movement test. |
...
| 1 | Amazon ASIN B00XRRNCOO | HiLetgo HX711 24-bit load-cell ADC module | diagnostic only; replacement pending | The present installed path communicated but failed the 2026-09-13 clear-start scale traces: it did not distinguish zero force from first contact and lagged physical release. Retain it for comparison; do not use it for production force control. |
| 1 | NAU7802 load-cell ADC breakout, exact seller/revision pending receipt | Purchased 2026-09-13 before the CS1238 selection. It is not the active replacement path. | spare; not installed | Retain unmodified. Do not wire it in parallel with another load-cell ADC. |
| 1 | CS1238 load-cell ADC breakout, HX711-form-factor, exact seller/revision pending purchase/receipt | Selected 2026-09-13 as the active HX711 replacement. The required breakout has the existing two-hole module footprint and header/terminal order: `VCC/GND/DT/SCK` and `E+/E-/A+/A-`. It retains the four-wire 300 g load cell, 3.3 V, `TOOL_GND`, GP0→`DT`/`DRDY-DOUT`, and GP1→`SCK`; its second differential channel remains unused. | selected; not installed | Confirm received silkscreen, 3.3 V range, header order, mounting-hole alignment, and that channel-A bridge terminals match the existing load-cell wires before plugging it in. Run E-07C through E-09C before enabling force control. |
| 2 | CS1238 load-cell ADC breakout | One is the production-replacement candidate; the second is reserved for the Pico 2 dual-sensor calibration fixture only if the instructor reference sensor is electrically compatible. | received/owner-reported; exact board revision TBD | Do not connect two ADCs to one bridge simultaneously. Inspect both boards and validate their 3.3 V/reference arrangements before use. |
| 1 | Raspberry Pi Pico 2 | Dedicated USB-connected dual-sensor calibration/data-acquisition controller; Pico ADC0 samples a proven-safe INA101 output and GPIO reads the toolhead CS1238. | received/owner-reported | Verify the board revision, USB data cable, 3.3 V rail, ADC reference/AGND, and final harness before recording force data. |
| 1 | Instructor-supplied 5 N strain-gauge/reference sensor and older INA101 board | Reference-force path for toolhead load-cell calibration; the INA101 is analogue signal conditioning, not an ADC. | received/owner-reported; electrical details unknown | Identify the sensor pinout, INA101 board supply rails/gain/output reference, and safe 0-3.3 V output span before connecting to Pico ADC0. |
...
| 1 | Owner-supplied compression spring | Installed 2026-09-04 as the replacement for the prior spring candidate; nominal dimensions are 0.4 mm wire diameter x 7 mm outside diameter x 25 mm free length. On 2026-09-08 its free length measured 25.00 mm outside the housing and the assembled spring-seat separation measured 20.37 mm unloaded and 1.95 mm at the lower housing endpoint (18.42 mm available compression span). | received/installed | Use 20.37 mm to 1.95 mm as the in-housing motion span; 1.95 mm is a hard endpoint, not a normal working minimum or free-spring `L_solid`. Measure LIFT/contact/selected-minimum lengths, force curve, endpoint margin, direction, and free-spring solid height or its specification in T-01A/T-01B before reusing any prior spring-dependent value. |
