...
- [ ] Hardware-validate the supervised bounded home-origin contact seek. Source now provides a 5 ms pulse seek with force, switch, pulse-count, and time limits; bench proof remains. (`T-02`, `T-01J`)
