...
|---|---|---|---|
| 2026-09-05 | M-02 in progress | In progress | A-axis rate ramp passed cleanly through `F540`; it returned exactly to the reference mark and remained cool. F480 current was approximately `0.465 A`; F540 current, X/Y checks, and configured-rate-ceiling check remain. |
