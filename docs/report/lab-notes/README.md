...
|---|---|---|---|
| 2026-09-05 | M-02 in progress | In progress | A-axis rate ramp passed cleanly through `F480`; it returned exactly to the reference mark, drew approximately `0.465 A`, and remained cool. X/Y rate checks and configured-rate-ceiling check remain. |
