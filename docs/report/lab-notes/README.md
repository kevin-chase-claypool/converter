...
|---|---|---|---|
| 2026-09-25 | T-01H M5 release and clearance pulse | Passed — measured | Several complete letter prints plus a four-cycle bench capture: the 57 ms pulse leaves a ~1.75 mm pen-tip gap, release clears to ~0 g (`F_release_off`), contact lands ~40-47 g (`F_contact_on`), no drag, and hundreds of cycles far exceed the 30 required. `PEN_CLEAR_VALID` flipped true. See [`2026-09-25-t-01h-clearance-confirmed-across-print-runs.md`](2026-09-25-t-01h-clearance-confirmed-across-print-runs.md). |
