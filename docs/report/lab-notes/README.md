...
|---|---|---|---|
| 2026-09-05 | M-02 in progress | In progress | A-axis rate ramp passed cleanly through `F600` (`0.485 A`, cool); the apparent 0.5 mm offset was traced to the pulley being moved during inspection. An audible plateau near `F500` needs STEP-frequency/configuration verification. |
