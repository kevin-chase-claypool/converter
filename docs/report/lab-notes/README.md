...
|---|---|---|---|
| 2026-09-24 | E-18 / M-08 / M-09 first integrated-firmware P113 registration | Passed — measured `MPos`/`G54` record; visual pen-centered check open | The production toolhead build with `MAGNETIC_CALIBRATION_VALID = true` ran `G65 P113` to completion: arm/release/re-arm, the 21-row center raster, the centroid pass, the two-footprint outer A scan, and both deferred `G54` writes. Center centroid at `MPos:-232.138,-219.475`; `G54` written `-232.136,-189.980,0.000,5649.193`. A spacing `4331.930` against the `4320 +/- 15` gate leaves only ~3 degrees of margin. See [`2026-09-24-e-18-m-08-p113-integrated-registration.md`](2026-09-24-e-18-m-08-p113-integrated-registration.md). |
