...
|---|---|---|---|
| 2026-09-22 | T-02 home-origin seek setup | Partial — revised candidate pending | The first 160 × 5 ms seek stopped safely at its pulse bound, still about 4.5 mm above paper and at only ~16 g normalized force. The revised supervised candidate uses 25 ms pulses / 50 ms settling with 80-pulse / 8-second bounds. |
