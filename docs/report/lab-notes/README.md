...
|---|---|---|---|
| 2026-09-05 | M-02 complete, M-05 open | Passed (unloaded) | A-axis acceleration tests through `$123=6000` / `F80000` were repeatedly smooth with exact mark returns; the F40000 test read `0.492 A` moving and `0.122 A` idle, and both motor and driver remained cool by touch. M-05 bed-ratio and X/Y checks remain; pen-force testing is separate. |
