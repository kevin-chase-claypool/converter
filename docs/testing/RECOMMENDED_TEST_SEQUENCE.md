...
20. **T-01B through T-01J — Motor/preload, M5-clear, calibration-profile, and
    interchangeable-tool envelope.**
    ...
    without reaching the LIFT-home switch, T-01I proves profile persistence
    plus a RAM-only startup baseline, and T-01J proves each intended pen or
    pencil can contact and clear without a shared tip-height datum; proceed to
    contact seek. **Fail or
