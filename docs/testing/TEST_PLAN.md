...
|---|---|---|---|---|
| E-01 | Confirm each stepper coil pair with ohmmeter | Black/green and red/blue pairs | Partial | Owner hand-turn generated-voltage test confirmed all three 17HS15 motors have black/green and red/blue coil pairs on 2026-08-19. Latest wiring plan: X is the sole shielded motor run; Y/A retain the black/green and red/blue pairs. Winding-resistance measurement and final X shield-bond continuity remain open. See `2026-08-19-e-01-y-stepper-coil-pair-test.md`. |
