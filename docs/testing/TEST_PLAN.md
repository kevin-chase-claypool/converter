...
| T-02 | Contact seek | From GP2 home, the bounded two-touch seek finds paper at approximately 5 g using 25 ms pulses far from contact and 5 ms pulses after one-fifth surface force; it backs off 10 ms, then tunes to the lower 30 g edge with only 5 ms pulses. Surface seek must complete before 100 pulses/8 seconds, force tune before 100 pulses/7 seconds, or fault with driver asleep; remain below the 60 g hard limit. Verify switch release within the first 30 surface pulses. |
