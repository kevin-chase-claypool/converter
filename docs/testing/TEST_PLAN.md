...
| E-19 | Verify E-stop/Halt input | With power removed, upper NC-A `1`–`2` is continuous released/open pressed and lower NC-B is isolated/insulated. With NC-A across RP23CNC `ESTOP SIG`/`GND` and NC-compatible `$14=6` verified live, pressing SW1 enters Halt; deliberate Reset/Unlock is required after release and no automatic movement occurs. Motor/tool 12 V remains powered. | Partial — Halt response passed | ioSender 2.0.47 screenshot on 2026-09-08 shows `$14=6`, then pressing SW1 asserted E-stop and produced `ALARM:10` / `MSG:Emergency stop, clear then reset to continue`. Release, Reset/Unlock, no-auto-restart, and unpowered contact-continuity evidence remain; see `2026-09-08-e-19-estop-iosender-configuration.md`. |
