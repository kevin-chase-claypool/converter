...
| E-19 | Verify E-stop/Halt input | With power removed, upper NC-A `1`–`2` is continuous released/open pressed and lower NC-B is isolated/insulated. With NC-A across RP23CNC `ESTOP SIG`/`GND` and NC-compatible `$14=6` verified live, pressing SW1 enters Halt; deliberate Reset/Unlock is required after release and no automatic movement occurs. Motor/tool 12 V remains powered. | Partial — setting snapshot | ioSender 2.0.47 screenshot on 2026-09-08 shows Setting `14`, `Invert control inputs: 6`, Feed hold/Cycle start selected, and E-stop clear. No press/release, Reset/Unlock, or continuity result yet; see `2026-09-08-e-19-estop-iosender-configuration.md`. |
